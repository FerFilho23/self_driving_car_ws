...
class VideoRecorderNode(Node):
    ...
    def __init__(self):
        ...
        self.out = cv2.VideoWriter('/home/ferfilho/ros2/self_driving_car_ws/src/self_driving_car_pkg/self_driving_car_pkg/video_recorder_out/output.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 30, (1280,720))
